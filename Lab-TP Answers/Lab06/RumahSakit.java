...
class RumahSakit {
    ...
    static private void handleLog(Warga X) {
		...
		if (X instanceof Pasien) { // Jika pasien
            // Melakukan downcasting agar dapat menggunakan method khusus pasien
            Pasien xSebagaiPasien = (Pasien) X; 
			out.println(xSebagaiPasien.getHappiness()); // TODO: Lengkapi dengan happiness pasien
			out.println(xSebagaiPasien.getStatusSembuh()); // TODO: Lengkapi dengan status kesembuhan pasien
		} else { // Jika dokter
            // Melakukan downcasting agar dapat menggunakan method khusus dokter
            Dokter xSebagaiDokter = (Dokter) X;
			out.println(xSebagaiDokter.getJumlahPasienDitemui()); // TODO: Lengkapi dengan jumlah pasien yang ditemui dokter
		}
